...
| Flutter client | Rust bridge, encrypted profiles, invitation enrollment, pairing and identity-kit export/restore with durable retries; macOS and Android build checks in CI | Conversation UI, KeyPackage status and physical-device acceptance |
