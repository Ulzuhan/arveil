...
Future<void> main() async {
  ...
  test(
    'a profile opens, answers, refuses a second session and closes',
    () async {
      final dir = Directory.systemTemp.createTempSync('arveil-m3b0').path;
      ...
      expect((await profile.setup()).stage, SetupStage.new_);
      ...
      expect(
        progress
            ...
            .whereType<ProgressKindView_Onboarding>(),
        isNotEmpty,
      ...
      expect((await reopened.setup()).stage, SetupStage.identityReady);
